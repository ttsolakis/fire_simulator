...
Here’s an example fire spread simulation (click to enlarge):

![Fire Spread Demo](examples/my_fire.gif)


*(More results and an animation are available in the `examples/` folder — e.g., `my_fire.mp4`.)*
